...
if TYPE_CHECKING:
    from oscat.settings import OscatSettings
...
def minds_request(
    ...
    *,
    ...
    req.add_header(
        "User-Agent",
        "Mozilla/5.0 (compatible; OSCAT/1.0;"
...
def describe_minds_connection_error(err: Exception) -> tuple[str, str]:
    ...
    if isinstance(err, urllib.error.HTTPError):
        ...
        return (
            ...
            "Common reasons: a server response OSCAT could not use or a transient connectivity problem.",
        )
    ...
    if isinstance(err, urllib.error.URLError):
        ...
        return (
            ...
            "Common reasons: network connectivity problems, DNS issues, or a server OSCAT could not reach.",
        )
...
def refresh_knowledge(settings: OscatSettings, cortex) -> None:
