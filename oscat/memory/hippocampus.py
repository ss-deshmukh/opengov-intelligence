"""Hippocampus — OSCAT's memory encoding and retrieval engine.
...
class Hippocampus:
    ...
    def __init__(self, base_dir: Path) -> None:
        ...
        Args:
            base_dir: ~/.oscat/memory/ (global) or <project>/.oscat/memory/ (project)
        """
        self._dir = base_dir
    ...
    def _encode_with_lock(self, path: Path, text: str, mode: str = "append") -> None:
        ...
        Prevents corruption from concurrent OSCAT sessions writing to
