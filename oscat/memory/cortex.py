"""Cortex — OSCAT's executive memory coordinator.
...
class Cortex:
    """Executive coordinator for OSCAT's memory systems.
    ...
    def __init__(
        ...
        Args:
            global_dir: Path to ~/.oscat/memory/ (cross-project memories)
            project_dir: Path to <project>/.oscat/memory/ (project-specific)
