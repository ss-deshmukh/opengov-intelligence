...
from oscat.llm.provider import LLMProvider, LLMResponse, StreamEvent
...
class LLMClient:
    ...
    @classmethod
    def from_settings(cls, settings: OscatSettings) -> LLMClient:
        from oscat.llm.anthropic import AnthropicProvider
        from oscat.llm.openai import OpenAIProvider
