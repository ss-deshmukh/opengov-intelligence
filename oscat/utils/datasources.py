...
from oscat.datasource_registry import DatasourceRegistry, _YAML_BLOCK_RE

if TYPE_CHECKING:
    from oscat.datasource_registry import DatasourceEngine
...
def build_datasource_context(active_only: str | None = None) -> str:
    ...
    lines.append(
        ...
        "Never read ~/.oscat/data_vault/ files directly.\n"
    )
    for c in conns:
